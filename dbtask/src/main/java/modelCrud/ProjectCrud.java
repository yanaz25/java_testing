...
public class ProjectCrud extends Crud {
    ...
    public ProjectModel selectByName(String name) {
        ProjectModel projectModel = selectByParameter(NAME_COLUMN, name);
        return projectModel;
    }

    public void insertRows(ProjectModel projectModel) {
        insertRow(ALL_COLUMNS, projectModel.getId(), projectModel.getName());
    }
}
